# Maticon Office DocSpace JavaScript SDK

[RU](README.md) | [EN](README.en.md)

## Basic concepts

The Maticon Office DocSpace SDK based on JavaScript allows developers to use all the DocSpace possibilities with *api.js*. You can integrate Maticon Office DocSpace into your own web application, allowing users to create and submit documents directly from your website. For example, you can use the Maticon Office DocSpace [React component](https://api.maticonoffice.ru/docspace/javascript-sdk/get-started/react-component/) to integrate Maticon Office DocSpace into React projects.
...
where **{PORTAL\_SRC}** is the name of the server with the Maticon Office DocSpace installed.
...
If the users are not authenticated, they will see a page asking them to sign in to DocSpace the first time they use it. Authentication is also possible through the SDK [methods](https://api.maticonoffice.ru/docspace/javascript-sdk/usage-sdk/methods/#login).
...
Initialize DocSpace frame using the [initFrame](https://api.maticonoffice.ru/docspace/javascript-sdk/usage-sdk/methods/#initframe) method with the SDK config passed to it:
...
You can use other available [methods](https://api.maticonoffice.ru/docspace/javascript-sdk/usage-sdk/methods/) to initialize DocSpace.

The full list of [config parameters](https://api.maticonoffice.ru/docspace/javascript-sdk/usage-sdk/config/) can be found here.

## Step 6. Using

After initialization, the current SDK instance can be accessed by using its [frameId](https://api.maticonoffice.ru/docspace/javascript-sdk/usage-sdk/config/#frameid). The list of current SDK instances is available in the *DocSpace.SDK.frames* array. To get the specific SDK instance, use the following string:
